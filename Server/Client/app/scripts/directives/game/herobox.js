...
angular.module('sbAdminApp')
    ...
    return {
        restrict : 'E',
        template : '<img class="img-circle" src="http://ddragon.leagueoflegends.com/cdn/6.7.1/img/champion/{{name}}.png" style="margin-bottom:10px;cursor:pointer;" height="50px"/>',
        scope: {
            name: "=",
        },
        replace:true
