...
namespace LoLLauncher
{
    ...
    {
        public static Dictionary<string, string> regionList = new Dictionary<string, string>();
        ...
        public static void buildAll()
        {
            ...
            foreach (Region rg in Enum.GetValues(typeof(Region)))
            {
                if (!regionList.ContainsKey(rg.ToString()))
                {
                    ...
                    {
                        RegionSave newSave = new RegionSave() { version = "6.8.16_05_01_19_57" };
        ...
        public static void updateRegionVersion(string name, string version)
        {
            ...
            RegionSave newSave = new RegionSave() { version = version };
